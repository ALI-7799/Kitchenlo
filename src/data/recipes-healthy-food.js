...
(function (root, factory) {
  ...
  else (root.KITCHENLO_DATA = root.KITCHENLO_DATA || {}).healthyFood = factory();
  ...
  return [
    ...
    },
    {
      ...
      imageAlt: 'Green smoothie bowl topped with berries, banana and seeds',
      prepMinutes: 8,
      cookMinutes: 0,
      servings: 2,
      yieldText: '2 bowls',
    ...
    },
    {
      ...
      imageAlt: 'Avocado quinoa bowl with roasted vegetables and tahini dressing',
      prepMinutes: 15,
      cookMinutes: 30,
      servings: 4,
      yieldText: '4 bowls',
    ...
    },
    {
      ...
      imageAlt: 'A bright bowl of lentil herb soup topped with parsley',
      prepMinutes: 12,
      cookMinutes: 38,
      servings: 6,
    ...
    },
    {
      ...
      imageAlt: 'Roasted vegetable wrap cut in half showing the filling',
      prepMinutes: 15,
      cookMinutes: 25,
      servings: 4,
      yieldText: '4 wraps',
    ...
    },
    {
      ...
      imageAlt: 'Citrus kale salad with orange segments and toasted seeds on a white plate',
      prepMinutes: 18,
      cookMinutes: 5,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Herbed yogurt bowl topped with cucumber, seeds and olive oil',
      prepMinutes: 10,
      cookMinutes: 4,
      servings: 2,
      yieldText: '2 bowls',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1529042410759-befb1204b468?auto=format&fit=crop&w=1200&q=80',
      imageAlt: 'Stuffed bell peppers with rice, beans and melted cheese on a baking tray',
      prepMinutes: 20,
      cookMinutes: 45,
      servings: 6,
    ...
    },
    {
      ...
      imageAlt: 'Warm farro salad with roasted squash and greens',
      prepMinutes: 15,
      cookMinutes: 35,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Coconut rice bowl with pickled vegetables, edamame and peanut sauce',
      prepMinutes: 18,
      cookMinutes: 22,
      servings: 4,
      yieldText: '4 bowls',
