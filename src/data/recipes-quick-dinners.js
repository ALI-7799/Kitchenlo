...
(function (root, factory) {
  ...
  else (root.KITCHENLO_DATA = root.KITCHENLO_DATA || {}).quickDinners = factory();
  ...
  return [
    ...
    },
    {
      ...
      imageAlt: 'Pesto tortellini with chicken and cherry tomatoes in a shallow bowl',
      prepMinutes: 5,
      cookMinutes: 15,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Taco rice bowls topped with avocado, salsa and lime wedges',
      prepMinutes: 10,
      cookMinutes: 18,
      servings: 4,
      yieldText: '4 bowls',
    ...
    },
    {
      ...
      imageAlt: 'Miso noodle stir-fry with tofu, snap peas and carrots',
      prepMinutes: 12,
      cookMinutes: 13,
      servings: 4,
      yieldText: '4 bowls',
    ...
    },
    {
      ...
      imageAlt: 'Mediterranean flatbread with olives, tomatoes and feta on a wooden board',
      prepMinutes: 8,
      cookMinutes: 12,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Honey soy glazed chicken with broccoli and peppers in a skillet',
      prepMinutes: 10,
      cookMinutes: 16,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Ricotta toasts topped with wilted spinach on a serving platter',
      prepMinutes: 6,
      cookMinutes: 9,
      servings: 4,
    ...
    },
    {
      ...
      imageAlt: 'Smoky tomato pasta twirled in a wide bowl with basil',
      prepMinutes: 8,
      cookMinutes: 22,
      servings: 4,
      yieldText: '4 servings',
    ...
    },
    {
      ...
      imageAlt: 'Lemon herb shrimp in a pan sauce with parsley and lemon wedges',
      prepMinutes: 8,
      cookMinutes: 9,
      servings: 4,
      yieldText: '4 servings',
    ...
    },
    {
      ...
      imageAlt: 'Crisp broccoli quesadillas cut into wedges on a plate',
      prepMinutes: 10,
      cookMinutes: 16,
      servings: 4,
